        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Course_ComboCourse_ComboCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Conlusion = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NextStepAfterAnswer = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreateBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2b729efa-3446-405b-9dc7-059a4c451296"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7306), false, null, null, "Kỹ năng sinh tồn" },
                    { new Guid("3a477216-d412-43ca-b05f-653bc84f6609"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7303), false, null, null, "Kiến thức sơ cấp cứu" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("81e210f8-9274-44c5-9256-481acce0e8ec"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7436), false, null, null, "Premium" },
                    { new Guid("edd4ae9e-0e26-4ed4-9812-0fbe587fcdb3"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7433), false, null, null, "Freemium" }
                });

            migrationBuilder.InsertData(
                table: "EmergencyCategory",
                columns: new[] { "Id", "CreateBy", "Created", "Description", "IsDelete", "LastModified", "LastModifiedBy", "Name", "PriorityLevel" },
                values: new object[,]
                {
                    { new Guid("5c43ff6a-1903-4fdc-911b-52e32cbe3633"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(6800), null, false, null, null, "Thương tích", 3 },
                    { new Guid("5dca6c16-f112-4517-8655-3b03cfb7a716"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(6688), null, false, null, null, "Khẩn cấp", 1 },
                    { new Guid("76b241ee-7275-4449-ad4d-6813ac2c112a"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(6802), null, false, null, null, "Bệnh lý", 4 },
                    { new Guid("93aeda91-ae3c-448a-bb89-497f28256563"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(6797), null, false, null, null, "Ưu tiên", 2 },
                    { new Guid("a403ff66-6735-4516-ae28-23de65c52cea"), null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(6806), null, false, null, null, "Kỹ năng", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0e4ebaac-a0e4-4aa8-8d6c-6eefa8dc4d63"), "Bạn đã an toàn", "Xin chúc mừng", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7016), new Guid("48ae3bff-69b9-49f6-ad3e-e7408e44c081"), false, true, null, null, "hoahoan_main_step_5", 5, "1. Thoát ra khỏi đám cháy\r\n2. Tránh nơi có nhiều khói" },
                    { new Guid("1262623d-475a-4015-bc55-282650e90cde"), "Rà soát nguyên nhân", "KIỂM TRA NGUYÊN NHÂN GÂY SỐC PHẢN VỆ & NGƯNG TIẾP XÚC VỚI TÁC NHÂN GÂY DỊ ỨNG (NẾU CÓ)", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7189), new Guid("1822976f-01d7-4a12-ba20-46e5004cc71c"), false, true, null, null, "socphanve_main_step_7", 7, "1. Sơ cấp cứu khẩn cấp\r\n2. Tránh tăng mức độ sốc" },
                    { new Guid("1aedfbb6-ef6c-40c3-b5e0-8c11ae6157e4"), "Rửa vết thương bằng nước sạch", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7020), new Guid("1f04befb-e7a8-4c34-87fe-5a61795fdc2a"), false, false, null, null, "dongvat_main_step_1", 1, "Hạn chế tối đa nguy cơ nhiễm trùng" },
                    { new Guid("294142fc-8261-4d46-b670-5301cd5ce420"), "Nâng cao vị trí máu chảy so với tim", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7079), new Guid("bd166379-995b-449d-b381-db1fd362be0c"), false, false, null, null, "cammau_main_step_3", 3, "1. Giảm áp lực máu\r\n2. Giảm nguy cơ mất máu" },
                    { new Guid("350bcba3-0e35-448a-b6a3-0da6d377e80e"), "Đánh giá tình trạng", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7161), new Guid("1822976f-01d7-4a12-ba20-46e5004cc71c"), false, false, null, null, "socphanve_main_step_1", 1, "1. Sơ cấp cứu khẩn cấp\r\n2. Tránh tăng mức độ sốc" },
                    { new Guid("40e1f63e-7e31-4466-bd67-7aee4c28dd7f"), "GỌI 115", "BÁO CÁO TÌNH TRẠNG BỆNH NHÂN", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7170), new Guid("1822976f-01d7-4a12-ba20-46e5004cc71c"), false, false, null, null, "socphanve_main_step_2", 2, "1. Sơ cấp cứu khẩn cấp\r\n2. Tránh tăng mức độ sốc" },
                    { new Guid("5074c5aa-b04b-41df-89a2-3177705c1a57"), "GỌI 114", null, "Chuông báo", "hoahoan_left_step_1", "Hô hoán", "hoahoan_right_step_1", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(6988), new Guid("48ae3bff-69b9-49f6-ad3e-e7408e44c081"), false, false, null, null, "hoahoan_main_step_1", 1, "1. Thoát ra khỏi đám cháy\r\n2. Tránh nơi có nhiều khói" },
                    { new Guid("51328c0e-fefd-4cf0-8407-9dd7e2e7afc4"), "Xác định vị trí chảy máu", "Chảy máu từ động mạch hoặc chảy máu từ tĩnh mạch", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7071), new Guid("bd166379-995b-449d-b381-db1fd362be0c"), false, false, null, null, "cammau_main_step_1", 1, "Nhanh chóng tiếp cận vết thương" },
                    { new Guid("51b70068-3066-4e06-a5ba-bf3cf1d9639f"), "Nếu bệnh nhân nôn hay chảy máu", "Lật người bệnh nằm nghiêng", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7178), new Guid("1822976f-01d7-4a12-ba20-46e5004cc71c"), false, false, null, null, "socphanve_main_step_4", 4, "1. Sơ cấp cứu khẩn cấp\r\n2. Tránh tăng mức độ sốc" },
                    { new Guid("64d9b4f9-b12a-4c66-9b12-e1f79e4b7878"), "Tìm lối thoát hiểm gần nhất, kiểm tra xem có khói không?", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(6999), new Guid("48ae3bff-69b9-49f6-ad3e-e7408e44c081"), false, false, null, null, "hoahoan_main_step_2", 2, "1. Thoát ra khỏi đám cháy\r\n2. Tránh nơi có nhiều khói" },
                    { new Guid("7f0b42f9-0602-4a55-b9d8-ced88911e477"), "Chích ngừa uốn ván", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7068), new Guid("1f04befb-e7a8-4c34-87fe-5a61795fdc2a"), false, true, null, null, "dongvat_main_step_3", 3, "Ngăn ngừa bệnh dại" },
                    { new Guid("89c531da-3abc-4859-8337-408d8d556d06"), "Dùng khăn hoặc gạc sạch để ép lên vết thương", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7075), new Guid("bd166379-995b-449d-b381-db1fd362be0c"), false, false, null, null, "cammau_main_step_2", 2, "Giảm nguy cơ mất máu quá nhiều" },
                    { new Guid("8df4266c-fd44-4e86-8cf0-f030ca219e71"), "Đi đến bệnh viện gần nhất để khám", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7155), new Guid("bd166379-995b-449d-b381-db1fd362be0c"), false, true, null, null, "cammau_main_step_6", 6, "Đánh giá chính xác tình trạng của vết thương" },
                    { new Guid("a0ae585b-182f-4df1-b596-429571d81c3d"), "Hồi sức tim phổi", "NẾU BỆNH NHÂN NGƯNG THỞ", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7186), new Guid("1822976f-01d7-4a12-ba20-46e5004cc71c"), false, false, null, null, "socphanve_main_step_6", 6, "1. Sơ cấp cứu khẩn cấp\r\n2. Tránh tăng mức độ sốc" },
                    { new Guid("a29dae04-810f-4034-aad7-e293a28047aa"), "Điều chỉnh tư thế bệnh nhân", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7174), new Guid("1822976f-01d7-4a12-ba20-46e5004cc71c"), false, false, null, null, "socphanve_main_step_3", 3, "1. Sơ cấp cứu khẩn cấp\r\n2. Tránh tăng mức độ sốc" },
                    { new Guid("aaa16c5a-126a-43fe-921e-d856958c576b"), "Cố định vết thương bằng gạc", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7151), new Guid("bd166379-995b-449d-b381-db1fd362be0c"), false, false, null, null, "cammau_main_step_5", 5, "Hạn chế chuyển động của vùng bị tổn thương" },
                    { new Guid("abac6286-767d-4baa-bc63-2fcc3e70a48e"), "Hô hoán và chờ đợi", "Bình tĩnh ra tín hiệu và chờ đợi người đến cứu", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7012), new Guid("48ae3bff-69b9-49f6-ad3e-e7408e44c081"), false, true, null, null, "hoahoan_main_step_4", 4, "1. Thoát ra khỏi đám cháy\r\n2. Tránh nơi có nhiều khói" },
                    { new Guid("b07906a8-521b-4970-a421-2cc61520f749"), "Băng vô trùng ở vị trí vết thương", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7063), new Guid("1f04befb-e7a8-4c34-87fe-5a61795fdc2a"), false, false, null, null, "dongvat_main_step_2", 2, "1. Bảo vệ vết thương\r\n2. Giảm vi khuẩn từ môi trường" },
                    { new Guid("b7667346-a9df-4869-8ee4-814e44426b77"), "Đặt lực ép liên tục vào vết thương", null, null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7083), new Guid("bd166379-995b-449d-b381-db1fd362be0c"), false, false, null, null, "cammau_main_step_4", 4, "Giảm tốc độ chảy máu" },
                    { new Guid("cc4601b6-d9f9-4094-bc57-7105aa236761"), "Nói chuyện liên tục với bệnh nhân", "Giữ được nhiệp thở tránh trạng thái hôn mê", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7182), new Guid("1822976f-01d7-4a12-ba20-46e5004cc71c"), false, false, null, null, "socphanve_main_step_5", 5, "1. Sơ cấp cứu khẩn cấp\r\n2. Tránh tăng mức độ sốc" },
                    { new Guid("e73411bc-d4d7-4801-bdd9-d7df984b01aa"), "Dán kín cửa phòng", "Quay trở lại phòng trú ẩn, dùng băng dán hoặc vải để dán kín các khe hở tại cửa", null, null, null, null, null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7003), new Guid("48ae3bff-69b9-49f6-ad3e-e7408e44c081"), false, false, null, null, "hoahoan_main_step_3", 3, "1. Thoát ra khỏi đám cháy\r\n2. Tránh nơi có nhiều khói" }
                });

            migrationBuilder.InsertData(
                table: "AnswerContents",
                columns: new[] { "Id", "Answer", "CreateBy", "Created", "EmergencyDetailId", "IsDelete", "LastModified", "LastModifiedBy", "NextStepAfterAnswer" },
                values: new object[,]
                {
                    { new Guid("2a7ce08a-0967-439a-b0af-d3f0c80197d6"), "Tín hiệu đèn", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7281), new Guid("abac6286-767d-4baa-bc63-2fcc3e70a48e"), false, null, null, 0 },
                    { new Guid("58698e2d-fb2a-48c1-b064-085dd11c48d0"), "Không", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7275), new Guid("64d9b4f9-b12a-4c66-9b12-e1f79e4b7878"), false, null, null, 3 },
                    { new Guid("6e4caa08-8b57-4090-8bb4-3507199e0be3"), "Tín hiệu còi", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7284), new Guid("abac6286-767d-4baa-bc63-2fcc3e70a48e"), false, null, null, 0 },
                    { new Guid("c125f973-8af1-417e-87be-ff5f46ffdf5c"), "Có", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7272), new Guid("64d9b4f9-b12a-4c66-9b12-e1f79e4b7878"), false, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "MiniContent",
                columns: new[] { "Id", "Content", "ContentUrl", "CreateBy", "Created", "EmergencyDetailId", "IsDelete", "LastModified", "LastModifiedBy" },
                values: new object[,]
                {
                    { new Guid("27891a29-9107-45a3-812c-766d52779ab7"), "Tuần hoàn", "socphanve_step_1_mini_content_2", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7229), new Guid("350bcba3-0e35-448a-b6a3-0da6d377e80e"), false, null, null },
                    { new Guid("636af2b3-96fe-4fed-9e59-23c5c5941a14"), "Ý thức", "socphanve_step_1_mini_content_3", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7233), new Guid("350bcba3-0e35-448a-b6a3-0da6d377e80e"), false, null, null },
                    { new Guid("80ee8583-ff0b-49ae-81d2-0e5b0724ade7"), "Nới lỏng quần áo & đắp chăn", "socphanve_step_3_mini_content_2", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7238), new Guid("a29dae04-810f-4034-aad7-e293a28047aa"), false, null, null },
                    { new Guid("a2ecd786-f8bd-47f8-8900-be1407c3ccd0"), "Hô hấp", "socphanve_step_1_mini_content_1", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7223), new Guid("350bcba3-0e35-448a-b6a3-0da6d377e80e"), false, null, null },
                    { new Guid("cbc76dac-42da-4b4b-807d-aab23b875e93"), "Hà hơi thổi ngạt", "socphanve_step_6_mini_content_2", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7246), new Guid("a0ae585b-182f-4df1-b596-429571d81c3d"), false, null, null },
                    { new Guid("e27d22b8-e12d-4906-985c-bcc6a28aeeab"), "Đặt bệnh nhân nằm tư thế chân cao hơn đầu", "socphanve_step_3_mini_content_1", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7235), new Guid("a29dae04-810f-4034-aad7-e293a28047aa"), false, null, null },
                    { new Guid("e5919e2d-642b-46da-980d-ef68f365c0da"), "Ép hơi lồng ngực", "socphanve_step_6_mini_content_1", null, new DateTime(2024, 2, 19, 14, 0, 12, 414, DateTimeKind.Local).AddTicks(7241), new Guid("a0ae585b-182f-4df1-b596-429571d81c3d"), false, null, null }
                });
